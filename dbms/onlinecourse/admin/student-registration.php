...
$ret=mysqli_query($con,"insert into students(studentName,StudentRegno,password,passcode) values('$studentname','$studentregno','$password','$pincode')");
if($ret)
{
echo '<script>alert("Student Registered Successfully. Passcode is "+"'.$pincode.'")</script>';
