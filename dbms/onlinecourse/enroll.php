...
$course=$_POST['course'];
$sem=$_POST['sem'];
$ret=mysqli_query($con,"insert into courseenrolls(studentRegno,passcode,session,department,level,course,semester) values('$studentregno','$pincode','$session','$dept','$level','$course','$sem')");
if($ret)
{
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="Passcode" name="Passcode" readonly value="<?php echo htmlentities($row['passcode']);?>" required />
  </div>   

<div class="form-group">
    <label for="Passcode">Student Photo  </label>
